...
if (isset($_GET['type']) && ($_GET['type'] == 'add'))
{
    if(isset($_GET['id']))
    {
        ...
        $request_db = "SELECT * FROM products WHERE id = :id";
        $productByCode = $database->Read($request_db, ["id" => $id]);
        $itemArray = array($productByCode[0]['id'] => array('name' => $productByCode[0]['name'], 
            'id' => $productByCode[0]['id'], 'price' => $productByCode[0]['price'], 'quantity' => 1, 'image' => $productByCode[0]['image']));

            if (!empty($_SESSION['cart']))
            {
                if (in_array($productByCode[0]['id'], array_keys($_SESSION['cart'])))
                {
            ...
            <div class="container">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            <?php
                                $statement = "SELECT * FROM products ORDER BY created_at ASC LIMIT 0, 9";
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                            <div class="single-popular-items mb-50 text-center">
                                                <div class="popular-img">
                                                    ...
                                                    <a href="shop.php?type=add&id=<?php echo $product['id']; ?>">
                                                        <div class="img-cap">
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="row">
                        <?php
                                $statement = "SELECT * FROM products ORDER BY price DESC LIMIT 0, 9";
                                $products = $database->Read($statement);
                    ...
                    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                        <div class="row">
                            <?php
                                $statement = "SELECT * FROM products ORDER BY popularity DESC LIMIT 0, 9";
                                $products = $database->Read($statement);
