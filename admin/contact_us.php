...
$sql = "SELECT * FROM contact_us ORDER BY id LIMIT $start_from, $limit";
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content" style="padding-left: 20px; width: 100vw">
            ...
            <?php
                $result_db = "SELECT COUNT(id) FROM contact_us";
                ...
                {
                    if ($i == $page)
                    $pagLink .= "<a class='btn view-btn1' style='margin-right:20px; background-color: grey; color: red;' href='contact_us.php?page=" . $i . "'>" . $i . "  </a>";
                    else
                    {                            
                        $pagLink .= "<a class='btn view-btn1' style='margin-right:20px' href='contact_us.php?page=" . $i . "'>" . $i . "  </a>";
                    }
                }
                echo $pagLink;
            ?>
