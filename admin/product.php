...
$sql = "SELECT * FROM products ORDER BY id LIMIT $start_from, $limit";
    ...
    <div class="wrapper">
        ...
        <div id="content" style="padding-left: 20px; width: 100vw">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="../assets/img/gallery/<?php echo $row['image']?>" style="width: 50px; height: 50px"/></td>
                                <td><?php echo $row['description'] ?></td>
                                <td><?php echo $row['price'] ?></td>
                                <td><?php echo $row['popularity'] ?></td>
                                <td style="text-align: center;">
                                    <span class='sett edit' style="margin-bottom: 10px"><a href="manage_product.php?id=<?php echo $row['id']; ?>">Edit</a></span>
                                    <span class='sett delete'><a href="product.php?type=delete&id=<?php echo $row['id'] ?>">Delete</a><span>
                                </td>
                            </tr>
                        <?php
                            }
            ...
            <?php
                ...
                {
                    if ($i == $page)
                    $pagLink .= "<a class='btn view-btn1' style='margin-right:20px; background-color: grey; color: red;' href='product.php?page=" . $i . "'>" . $i . "  </a>";
                    else
                    {                            
                        $pagLink .= "<a class='btn view-btn1' style='margin-right:20px' href='product.php?page=" . $i . "'>" . $i . "  </a>";
                    }
                }
                echo $pagLink;
            ?>
